...
if(isset($_POST['daftar'])){
    ...
    if($cek_login > 0){
      ...
      echo "<script>alert('Daftar Berhasil');document.location = 'login.php'</script>";
    }
}
?>
<!DOCTYPE html>
...
<?php 
    ...
    <form action="" method="post">
        ...
        <!-- membuat form checkbox dengan perintah menjalankan function showHide() saat diklik -->
         <div class="container">
         <input type="checkbox" onclick="showHide()"> <p style="margin-left: 10px; margin-top: 10px;">Tampilkan Password </p>
         </div>
        <center>
         <p>Sudah punya akun?<a href="login.php" style="color: #0A97B0;">Daftar</a></p>
         </center>
